...
import client.LeaderboardClient;
...
public class QuizGUI extends Application {
    ...
    public void start(Stage stage) {
        ...
        try {
            Image iconImg = new Image("file:..//AssignmentGCIS124//images//xiconcircle.png");
        ...
        try {
            stage.getIcons().add(new Image("file:..\\AssignmentGCIS124\\images\\icon.jpeg"));
        } catch (Exception e) {
        ...
        try {
            Image welcome = new Image("file:..\\AssignmentGCIS124\\images\\welcome.jpg"); // path to it
        ...
        try {
            alwaysComeBackImage = new Image("file:..\\AssignmentGCIS124\\images\\always come back.png");
        } catch (Exception e) {
        ...
        try {
            Image bgGif = new Image("file:..\\AssignmentGCIS124\\gifs\\fnafsl.gif");
    ...
    private void showServerConnectDialog() {
        ...
        try {
            dialogStage.getIcons().add(new Image("file:..\\AssignmentGCIS124\\images\\icon.jpeg"));
        } catch (Exception e) {
    ...
    private void startQuizFlow() {
        try {
            ...
            String musicPath = new File("..\\AssignmentGCIS124\\audio\\FNAF Security Breach OST Daycare Theme.m4a")
                    .toURI().toString();
            ...
            quizQuestions.load("..\\AssignmentGCIS124\\txt\\questionsBase.txt");
    ...
    private void showfirstQuestion() {
        ...
        try {
            Image bgImage = new Image("file:..//AssignmentGCIS124//images//quizbackground.jpg");
        ...
        // 🟢 Pause icon setup
        ImageView pauseIcon = new ImageView(new Image("file:..//AssignmentGCIS124//images//pause-icon.png"));
    ...
    private void showPauseMenu() {
        ...
        pauseMenu.setStyle(
                "-fx-background-image: url('file:..//AssignmentGCIS124//gifs//pause.gif');" +
     ...
     */
     ...
     private void restartQuiz() {
        ...
        String musicPath = new File("..\\AssignmentGCIS124\\audio\\FNAF Security Breach OST Daycare Theme.m4a").toURI()
                .toString();
        Media media = new Media(musicPath);
        backgroundMusic = new MediaPlayer(media);
    ...
    private void showFinalScore(boolean timedOut) {
        ...
        try {
            Image bg = new Image("file:..//AssignmentGCIS124//images//game_over.png");
        ...
        if (onlineMode) {
            ...
            try (Scanner scanner = new Scanner(new File("..\\AssignmentGCIS124\\txt\\leaderboard.txt"))) {
            ...
            try {
                Image endImage = new Image("file:..//AssignmentGCIS124//images//the end.png");
    ...
    private void displayFullLeaderboard(Stage leaderboardStage) {
        ...
        try {
            ...
            Image bgImg = new Image("file:..//AssignmentGCIS124//images//static_background.png"); // CHANGE TO YOUR
                                                                                                  // IMAGE/GIF PATH
        ...
        try {
            leaderboardStage.getIcons().add(new Image("file:..\\AssignmentGCIS124\\images\\icon.jpeg"));
        } catch (Exception e) {
    ...
    private void saveScore() {
        ...
        try (FileWriter writer = new FileWriter("..\\AssignmentGCIS124\\txt\\leaderboard.txt")) {
